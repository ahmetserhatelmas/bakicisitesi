    ...
    <main className="overflow-x-hidden font-[var(--font-nunito)]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          />
          <WhatsAppButton className="bg-green-500 hover:bg-green-600 text-white font-bold px-5 py-2.5 rounded-full text-sm transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2">
      ...
      <WhatsAppButton className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl hover:shadow-green-300 transition-all duration-300 hover:scale-110 group">
